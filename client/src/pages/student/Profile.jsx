...
const Profile = () => {
  ...
  //mutation me square bracket use krte hain
  //Query me curly braces use krte hain  
  ...
  useEffect(()=>{
     ...
     if(isError){
        toast.error(error?.data?.message || "Couldn't update profile."  )
     }
    ...
    <div className='max-w-4xl mx-auto px-4 my-10' >
       ...
       <div>
         ...
         <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-5 '>
            {
                user.enrolledCourses.length === 0 ? <h1>You are not enrolled in any course.</h1> :
